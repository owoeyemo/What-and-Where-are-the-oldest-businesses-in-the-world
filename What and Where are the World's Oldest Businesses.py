...
businesses_countries = pd.merge(sorted_businesses, countries, on="country_code")
...
new_all_countries = countries.merge(all_businesses, on="country_code", how="outer", indicator=True)
new_missing_countries = new_all_countries[new_all_countries["_merge"] == "left_only"]
...
# Group businesses_categories_countries by continent and category
